  ...
  <body style="margin-bottom:70px">
    ...
    <div class="img-responsive top-image jumbotron">
      <div class="container" style="position: relative;">
        <a href="form.php" class="hidden-xs btn btn-danger btn-lg" style="position: absolute;right:5%;bottom: -28px;">
          <div class="glyphicon glyphicon-camera" style="padding-right: 4px"></div>俳句を詠んでみる
        </a>
        <a href="form.php" class="vissible-xs hidden-sm hidden-md hidden-lg btn btn-danger"  style="position: absolute;right:5%;bottom: -25px">
          <div class="glyphicon glyphicon-camera" style="padding-right: 4px"></div>俳句を詠んでみる
        </a>
      </div>
    </div>
